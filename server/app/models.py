...
class Call:
    def _init_(self,graph_coords,emotions,pos_percent,neg_percent,rating,language,duration,transcript,emotions_audio,employeename,created_at=None):
    ...
    def to_dict(graph_coords,emotions,pos_percent,neg_percent,rating,language,duration,transcript,issue,emotions_audio,employeename,created_at=None):
            return {
